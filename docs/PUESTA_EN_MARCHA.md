...
Para actualizar a `v1.3.1`, instale el nuevo MSI/EXE sobre la versión anterior en cada equipo y conserve los datos de la aplicación. Esta versión no requiere una migración SQL adicional.
