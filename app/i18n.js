...
(function () {
  ...
  var EN = Object.freeze({
    ...
    "Equipo Ganadería": "Livestock team",
    "Equipo Agricultura": "Crop team",
    "Equipo Demo": "Demo team",
    "Sanidad": "Animal health",
    "Administración": "Administration",
    "Eventos por tipo": "Events by type",
    "Qué actividades concentran los registros del filtro.": "Which activities account for most records in the current filter.",
    "Estado del trabajo": "Work status",
    "Planificado, confirmado como realizado y anulado.": "Planned, confirmed as completed, and cancelled.",
    "Evolución por mes": "Monthly trend",
    "Volumen de eventos registrados o programados.": "Volume of recorded or scheduled events.",
    "Pendientes por responsable": "Pending tasks by owner",
    "Carga operativa pendiente; “sin responsable” señala un dato a completar.": "Pending workload; “Unassigned” indicates missing ownership.",
    "Planificados": "Planned",
    "Anulados": "Cancelled",
    "Lectura responsable:": "How to interpret this:",
    "el cumplimiento se calcula sólo con tareas que tienen evidencia de haber sido planificadas y luego confirmadas. Una venta, mortandad, entrada u otro hecho cargado directamente como realizado no infla ese porcentaje. “Vencido” significa falta de confirmación en el sistema; no prueba que la tarea no se haya hecho.": "Compliance includes only tasks that were planned and later confirmed. A sale, mortality, entry, or other event recorded directly as completed does not increase that percentage. “Overdue” means completion has not been confirmed in the system; it does not prove the task was not performed.",
    "Plan versus registros reales": "Plan vs. recorded activity",
  ...
  var PATTERNS_EN = [
    ...
    [/^de (\d+) lotes(.*)$/u, "of $1 lots$2"],
    [/^(\d+) pasadas categoría-lote$/u, "$1 category–lot visits"],
    [/^1 registro requiere revisión$/u, "1 record needs review"],
    [/^(\d+) registros requieren revisión$/u, "$1 records need review"],
