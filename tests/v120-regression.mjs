...
assert.equal(value('APP_VERSION'),'1.3.0');
...
dom.window.close();
console.log('OK · v1.3.0 · descanso vs objetivo · Ubicar/Traer rodeo · persistencia Gantt · ficha contextual · ARIA sin tooltip nativo · fixture público');
process.exit(0);
